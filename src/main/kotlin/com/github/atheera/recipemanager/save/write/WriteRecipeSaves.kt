...
class WriteRecipeSaves(title: String, cat: String, subCat: String, instr: MutableList<String>, ingr: MutableList<String>, equipment: MutableList<String>, desc: String, link: String, temp: Int, cTemp: Int, egg: Boolean, gluten: Boolean, lactose: Boolean, vegan: Boolean, veget: Boolean) {
    ...
    init {
        ...
        val rec = createRecipeObject(title, cat, subCat, instr, ingr, equipment, desc, link, temp, cTemp, egg, gluten, lactose, vegan, veget)
        try {
